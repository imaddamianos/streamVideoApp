...
class HomePageViewController: UIViewController {
    ...
    func setupTableView() {
        ...
        horizontalTableView.register(MoviesTableViewCell.nib, forCellReuseIdentifier: MoviesTableViewCell.identifier)
    }
...
//        verticalCollectionView.register(MoviesCollectionViewCell.nib, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: MoviesCollectionViewCell.identifier)
